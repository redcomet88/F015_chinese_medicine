...
## 视频讲解
[video(video-uBRqI33U-1756358885965)(type-bilibili)(url-https://player.bilibili.com/player.html?aid=982490623)(image-https://i-blog.csdnimg.cn/img_convert/06281da1dad8ccbb83fbfa5d15a6450f.png)(title-neo4j知识图谱 Vue+flask 中药中医方剂大数据可视化系统)]
## 1 前言
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/ccf5038f78ef432b97c560056ffd9e55.png)
...
- 方剂、药材的关键词分析
### 3.1 逻辑架构图 && 功能模块图
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/4c7efc364cb64518b135c78b2fad290b.png)

![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/9404bd36674541f88d0119050a93fc7d.png)
### 3.2 设计背景
...
数据库: MySQL5.7、Neo4j3.5   (双数据库)
关键技术: d3js、echarts、pandas等
开发时间： 
## 4功能实现
...
采用echarts实现的知识图谱
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/6e9ee39495a844bc8f2777d82bbbace0.png)
主页： 轮播图、中药方剂信息卡片展示
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/aa4fafb43663463298854a935725eb22.png)
搜索方剂：模糊搜索方剂，展示信息卡片
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/f5041a51c2df4dc98205a096f8069867.png)
搜索药材：模糊搜索药材，展示信息卡片
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/db9042ccb4634f67806ba9e18aeb0cd3.png)
数据可视化大屏：中药方剂、药材的可视化分析，主要用echarts、d3.js的技术实现多维度分析
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/7df7aed02ce5498fa72806d9559d20a0.png)
关键词分析，采用主题词提取、textrank算法、tf-idf算法实现的关键词提取：
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/4527c174d3ac411aab6a5257dee821f1.png)
词云分析：实现一个中药方剂的【主治症候】的词云
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/0e17b46cb18641988efd2dc469cd7f32.png)
设置功能（修改用户信息、头像）
